...
public class Professeur extends Personne {
	...
	public Professeur(String nom, String prenom, LocalDate datenaiss, String matiere, int tauxHoraire, int nbHeures, String codeEnseignant){
	...
	public boolean equals(Professeur objet) {
